function [Ain2,bin2,Aeq1,beq,lb,ub] = fn_dual_game_value_P2(T,A,B,k,l,lm,G,P,Q,q)
...
for k_initial=1:k
    ...
    Ain1(row_index,size(Ain1,2))=-1; %for Z_0
    %bin1(row_index,1)=-mu(k_initial); %as in this case mu is a variable it will not be in the RHS
end
